...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/cdx-prepass.js --out .contextdx/skeleton.json --summary
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/cdx-prepass.js --scope-path <parent-node-path> --out .contextdx/skeleton.json --summary
```
